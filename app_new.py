...
offer_id_to_name = {
    ...
    "399074": "Celcomdigi Postpaid 5G Family 30",
    "399090": "CelcomDigi Postpaid 5G Family SE",
    "401065": "CelcomDigi Postpaid 5G 50 XV",
    "98758": "Gadget sim",
    "387069": "CelcomDigi Postpaid 5G Gadget 50 DS",
    "144881": "Go Digi 48",
    "237122": "Go Digi 48 Supp",
    "90006782": "Digi Postpaid 28",
    ...
    "399102": "CelcomDigi Postpaid 5G 80",
    "455088": "CelcomDigi Postpaid 5G Supp 120 2026",
    "435114": "CelcomDigi Fibre 2Gbps",
    "211011": "Go Digi 78 DS",
    "144882": "Go Digi 78  ",
    ...
    "455094": "CelcomDigi Postpaid 5G 80 2026",
    "455092": "CelcomDigi Postpaid 5G 45 SE 2026",
}
        ...
        with st.container():
            ...
            if end_row > 1:
                ...
                postpaid_plan_options = [
                    ...
                    ("ALL_399074", "ALL Celcomdigi Postpaid 5G Family 30"),
                    ("ALL_399090", "ALL CelcomDigi Postpaid 5G Family SE"),
                    ("ALL_401065", "ALL CelcomDigi Postpaid 5G 50 XV"),
                    ("ALL_98758", "ALL Gadget sim"),
                    ("ALL_387069", "ALL CelcomDigi Postpaid 5G Gadget 50 DS"),
                    ("ALL_144881", "ALL Go Digi 48"),
                    ("ALL_237122", "ALL Go Digi 48 Supp"),
                    ("ALL_90006782", "ALL Digi Postpaid 28"),
                    ("ALL_211011", "ALL Go Digi 78 DS"),
                    ("ALL_243246", "ALL Digi Postpaid 150 DS 2021"),
                    ("ALL_243294", "ALL Digi Postpaid 60 2021"),
                    ("ALL_455099", "ALL CelcomDigi Postpaid 5G 140 2026"),
                    ("ALL_455097", "ALL CelcomDigi Postpaid 5G 120 2026"),
                    ("ALL_455095", "ALL CelcomDigi Postpaid 5G 100 2026"),
                    ("ALL_399102", "ALL CelcomDigi Postpaid 5G 80"),
                    ("ALL_455088", "ALL CelcomDigi Postpaid 5G Supp 120 2026"),
                    ("ALL_435114", "ALL CelcomDigi Fibre 2Gbps"),
                    ("ALL_211011", "ALL Go Digi 78 DS"),
                    ("ALL_144882", "ALL Go Digi 78  "),
                    ("ALL_155275", "ALL Digi Postpaid 90"),
                    ...
                    ("ALL_455094", "ALL CelcomDigi Postpaid 5G 80 2026"),
                    ("ALL_455092", "ALL CelcomDigi Postpaid 5G 45 SE 2026"),
            ...
            if st.button("Generate Input Form", key="generate_form", use_container_width=True):
                ...
                if end_row > 1 and plan_option:
                    if is_prepaid:
                        ...
                        if plan_option == "ALL_214292":
                        ...
                        elif plan_option == "ALL_399074":
                            offer_ids = ["399074"] * end_row
                        elif plan_option == "ALL_399090":
                            offer_ids = ["399090"] * end_row
                        elif plan_option == "ALL_401065":
                            offer_ids = ["401065"] * end_row
                        elif plan_option == "ALL_98758":
                            offer_ids = ["98758"] * end_row
                        elif plan_option == "ALL_387069":
                            offer_ids = ["387069"] * end_row
                        elif plan_option == "ALL_144881":
                            offer_ids = ["144881"] * end_row
                        elif plan_option == "ALL_237122":
                            offer_ids = ["237122"] * end_row
                        elif plan_option == "ALL_90006782":
                            offer_ids = ["90006782"] * end_row
                            ...
                            offer_ids = ["399102"] * end_row
                        elif plan_option == "ALL_455088":
                            offer_ids = ["455088"] * end_row
                        elif plan_option == "ALL_435114":
                            offer_ids = ["435114"] * end_row
                        elif plan_option == "ALL_211011":
                            offer_ids = ["211011"] * end_row
                        elif plan_option == "ALL_144882":
                            offer_ids = ["144882"] * end_row
                        elif plan_option == "ALL_155275":
                            offer_ids = ["155275"] * end_row
                        elif plan_option == "ALL_147249":
                            offer_ids = ["147249"] * end_row
                        ...
                        elif plan_option == "ALL_455094":
                            offer_ids = ["455094"] * end_row
                        elif plan_option == "ALL_455092":
                            offer_ids = ["455092"] * end_row    
